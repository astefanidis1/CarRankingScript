...
Original file is located at
    https://colab.research.google.com/drive/1VA5Sq2Qq4-6c6Obiu5LSsFBwgNAKMuku
"""
...
def save_cars(df, all_cars, all_rd, car1, car2, filename="Car Rank Elos.csv"):
    print("Saving the following updates to the CSV:")
    ...
    for car in updated_cars:
        ...
        # Debug: Show updated values for each car
        updated_row = df.loc[df['Car'] == car]
        print(updated_row[['Car', 'Elo', 'RD']])
...
# Combine all cars for cross-tier matchups
...
all_matchups = {car: matchup_tracker[tier][car] for tier in tiers for car in matchup_tracker[tier]}
